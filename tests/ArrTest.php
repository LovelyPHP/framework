...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'LovelyPHP'], 'price', 100);
        $this->assertSame(['name' => 'LovelyPHP', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'LovelyPHP']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['LovelyPHP'], $values);
    }
    ...
    {
        $array = ['name' => 'LovelyPHP', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'LovelyPHP'], $array);
    }
    ...
    {
        $array = ['name' => 'LovelyPHP', 'price' => 100, 'orders' => 10];
    ...
    public function testPull()
    {
        ...
        $this->assertSame('LovelyPHP', $name);
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@lovelyphp.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        $this->assertSame(['i@lovelyphp.com' => 'Jane'], $array);
        // Does not work for nested keys
