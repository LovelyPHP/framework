...
<body>
    <?php if (\lovely\facade\App::isDebug()) { ?>
    ...
    <div class="copyright">
        <a title="官方网站" href="https://lovelyphp.mojy.xyz">LovelyPHP Wiki</a> 
        <span>V<?php echo \lovely\facade\App::version(); ?></span> 
        <span>{ 可爱且更高性能PHP框架 - 专为WEB及API设计 }</span>
    </div>
    <?php if (\lovely\facade\App::isDebug()) { ?>
    <script>
