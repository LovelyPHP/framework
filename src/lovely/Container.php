...
class Container implements ContainerInterface, ArrayAccess, IteratorAggregate, Countable
{
     ...
     * @return object
     */
    public function make($abstract, array $vars = array(), $newInstance = false)
    {
        $abstract = $this->getAlias($abstract);
     ...
     */
    public function invokeFunction($function, array $vars = array())
    {
        try {
     ...
     * @throws FuncNotFoundException
     */
    public function invokeMethod($method, array $vars = array(), $accessible = false)
    {
        if (is_array($method)) {
     ...
     * @return mixed
     */
    public function invokeReflectMethod($instance, $reflect, array $vars = array())
    {
        $args = $this->bindParams($reflect, $vars);
     ...
     * @return mixed
     */
    public function invoke($callable, array $vars = array(), $accessible = false)
    {
     ...
     * @throws ClassNotFoundException
     */
    public function invokeClass($class, array $vars = array())
    {
        try {
     ...
     * @deprecated
     */
    public static function factory($name, $namespace = '')
    {
        $class = str_contains($name, '\\') ? $name : $namespace . ucwords($name);

        return Container::getInstance()->invokeClass($class, func_get_args());
    }
